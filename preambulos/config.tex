...
\documentclass[a4paper,12pt,spanish,twoside,openany]{book}
\usepackage{amsmath}
...
\usepackage{acronym}
\usepackage{thumbpdf}
\usepackage[hidelinks,colorlinks=false,linkcolor=black,citecolor=blue]{hyperref}
\usepackage[hidelinks]{hyperref}
\usepackage{xurl} %%%break in extra-large url
...
%%%Los uso en los gráficos de densidad en simulaciones
\definecolor{babyblueeyes}{rgb}{0.63, 0.79, 0.95}
\definecolor{darkgreen}{rgb}{0.0, 0.5, 0.0}

%%%%%reduce space table-text
\setlength{\textfloatsep}{1.8 pt }
\setlength{\abovecaptionskip}{3.8pt} 
\setlength{\belowcaptionskip}{3.8pt}
...
%%%Para fecha en la portada
\usepackage{datetime} %%%data time
\newdateformat{monthyeardate}{%
  \monthname[\THEMONTH], \THEYEAR}

% Redefine \monthname to capitalize the first letter
...
{\color{myblue}\normalfont\bfseries\onehalfspacing}
   ...
   {0pt}
   {
   \huge\parbox{\dimexpr\linewidth-3.7cm}}[{\medskip\color{myblue}\titlerule[2.5pt]}\color{myblue}\vskip2pt\titlerule]
%   \titlespacing*{\chapter}{0pt}{-25pt}{1pt}
\usepackage{lipsum}

\titlespacing{\chapter}{0pt}{1pt}{30pt}  % Adjust the top margin space (before spacing)
%\titlespacing{\chapter}{\SingleSpacing} 
...
% Change figure and table numbering format
...
\definecolor{popc}{rgb}{0.6.,0.8.,0.2}
\definecolor{pcpg}{rgb}{0.58,0.34,0.92}
\definecolor{popg}{rgb}{0.35,0.31,0.81}
\definecolor{dppc}{rgb}{0.98, 0.2, 0.0}
%%%%%Fin colores%%%%%%%%%%%%%%
...
%%%Para evitar espacios blancos cuando la página no esta full text
\raggedbottom
\setlength\@fptop{0\p@}% float at the top

%%%%%%%%%%%%%Para imprimir código Python%%%%%%%%%%%%%%%
\usepackage{listings} %%Para imprimir codigo pyhton en anexos
...
%    basicstyle=\ttfamily\footnotesize,
    ...
    showtabs=false,                  
    tabsize=2,
    caption={\textcolor{myblue}{\lstname}},
    lineskip=-0.5ex
}

\lstset{style=mystyle}

% Setting font color of the caption to myblue
\captionsetup[lstlisting]{font={color=myblue, bf}}


% Redefining the caption name
